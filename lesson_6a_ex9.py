...
# in the Avatar's bag by 10%.
    ...
    def sprinkled_with_fairy_dust(self):
        self.gold_in_bag += self.gold_in_bag * 0.1
...
# of gold carried (in bag) and the amount of gold buried (in the ground).
    ...
    def __str__(self):
        return 'The avatar is: ' + self.name + ' with ' + self.hair + ' hair ' + 'and has ' + str(self.gold_in_bag) + ' gold in bag and ' + str(self.buried_gold) + ' gold buried.'
        #pass   # replace this line or delete it
