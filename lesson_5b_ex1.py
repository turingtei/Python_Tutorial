'''
Create a dictionary day_to_number that converts the days of
the week "Sunday", "Monday", … into the numbers 0, 1, ...,
respectively
'''
...
day_to_number = {"Sunday": 0, "Monday": 1, "Tuesday":2, "Wednesday":3,
